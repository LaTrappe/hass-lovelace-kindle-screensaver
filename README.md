...
This tool regularly takes a screenshot of a specific page of your home assistant setup. It converts it into the jpg grayscale format which Kindles can display.
...
- `OUTPUT_PATH=./output.jpg` (destination of rendered image. `OUTPUT_2`, `OUTPUT_3`, ... is also supported)
